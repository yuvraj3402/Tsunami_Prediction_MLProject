...
from tsunami.components.model_evaluation import ModelEvaluation
from tsunami.components.model_pusher import ModelPusher
from tsunami.config.configuration import configuration
import os,sys
from tsunami.entity.artifact_entity import *
    ...
    def start_model_evaluation(self,data_ingestion_artifact:DataIngestionArtifact,
        ...
        try:
            model_evaluation=ModelEvaluation(data_ingestion_artifact=data_ingestion_artifact, 
                                             model_evaluation_config=self.config.get_mode_evaluation_config(), 
